...
// Using an icon library like 'lucide-react' is common, but for simplicity,
// we can define SVG components directly.
...
const LinkedinIcon = (props) => (
    <svg fill="currentColor" viewBox="0 0 16 16" {...props}><path d="M0 1.146C0 .513.526 0 1.175 0h13.65C15.474 0 16 .513 16 1.146v13.708c0 .633-.526 1.146-1.175 1.146H1.175C.526 16 0 15.487 0 14.854V1.146zm4.943 12.248V6.169H2.542v7.225h2.401zm-1.2-8.212c.837 0 1.358-.554 1.358-1.248-.015-.709-.52-1.248-1.342-1.248-.822 0-1.359.54-1.359 1.248 0 .694.521 1.248 1.327 1.248h.016zm4.908 8.212V9.359c0-.216.016-.432.08-.586.173-.431.568-.878 1.232-.878.869 0 1.216.662 1.216 1.634v3.865h2.401V9.25c0-2.22-1.184-3.252-2.764-3.252-1.274 0-1.845.7-2.165 1.193v.025h-.016a5.54 5.54 0 01.016-.025V6.169h-2.4c.03.678 0 7.225 0 7.225h2.4z"/></svg>
);
      ...
      <div className="container mx-auto px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-10 mb-10">
          ...
          <div className="flex flex-col gap-4 lg:col-span-1">
            ...
            <div className="flex flex-col gap-3">
              ...
              <form className="flex items-center mt-2 border border-white rounded-md overflow-hidden">
                <input
                  type="email"
                  placeholder="Enter your email"
                  className="p-2 text-sm bg-transparent focus:outline-none text-white w-full"
                  aria-label="Email for subscription"
                />
                <button
                  type="submit"
                  aria-label="Subscribe"
                  className="p-2.5 bg-red-500 hover:bg-red-600 transition-colors"
                >
        ...
        <div className="border-t border-gray-800 pt-6 text-center">
          <p className="text-gray-500 text-sm">
            &copy; {new Date().getFullYear()} SSDN ENTERPRISES All Rights Reserved.
          </p>
        </div>
      </div>
    </footer>
