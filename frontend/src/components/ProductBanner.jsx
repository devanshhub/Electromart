...
function ProductBanner() {
    ...
    useEffect(() => {
        ...
        autoPlayRef.current = setInterval(nextSlide, 7000); // Change slide every 7 seconds
        ...
        >
            ...
            >
                {bannerSlides.map((slide) => (
                    ...
                    >
                        {/* Text Content */}
                        <div className={`flex-1 text-center ml-44 md:text-left ${slide.textColor} z-10`}>
                            <div className="flex items-center justify-center md:justify-start mb-2 opacity-80">
                                <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
                        ...
                        {/* Image */}
                        <div className="flex-1 flex items-center justify-center mr-8 mt-8 md:mt-0 relative">
                            <img
                                src={slide.imageUrl}
                                alt={slide.title}
